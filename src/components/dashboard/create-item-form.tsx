                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <div className="w-full sm:w-1/3">
                            ...
                            <div
                                className={`relative aspect-square rounded-xl border-2 border-dashed border-slate-300 dark:border-slate-700 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 overflow-hidden transition-all ${!imagePreview ? 'hover:bg-slate-100 dark:hover:bg-slate-900' : ''}`}
                            >
                                {imagePreview ? (
